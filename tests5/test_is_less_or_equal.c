...
Suite *test_is_less_or_equal(void) {
  ...
  tcase_add_test(tc, test_is_less_or_equal_ok61);
  tcase_add_test(tc, test_is_less_or_equal_ok62);
  tcase_add_test(tc, test_is_less_or_equal_ok63);
  tcase_add_test(tc, test_is_less_or_equal_ok64);
  tcase_add_test(tc, test_is_less_or_equal_ok65);
  tcase_add_test(tc, test_is_less_or_equal_ok66);
  tcase_add_test(tc, test_is_less_or_equal_ok67);
  tcase_add_test(tc, test_is_less_or_equal_ok68);
  tcase_add_test(tc, test_is_less_or_equal_ok69);
  tcase_add_test(tc, test_is_less_or_equal_ok70);
  tcase_add_test(tc, test_is_less_or_equal_ok71);
  tcase_add_test(tc, test_is_less_or_equal_ok72);
  tcase_add_test(tc, test_is_less_or_equal_ok73);
  tcase_add_test(tc, test_is_less_or_equal_ok74);
  tcase_add_test(tc, test_is_less_or_equal_ok75);
  tcase_add_test(tc, test_is_less_or_equal_ok76);
  tcase_add_test(tc, test_is_less_or_equal_ok77);
  tcase_add_test(tc, test_is_less_or_equal_ok78);
  tcase_add_test(tc, test_is_less_or_equal_ok79);
  tcase_add_test(tc, test_is_less_or_equal_ok80);
  tcase_add_test(tc, test_is_less_or_equal_ok81);
  tcase_add_test(tc, test_is_less_or_equal_ok82);
  tcase_add_test(tc, test_is_less_or_equal_ok83);
  tcase_add_test(tc, test_is_less_or_equal_ok84);
  tcase_add_test(tc, test_is_less_or_equal_ok85);
  tcase_add_test(tc, test_is_less_or_equal_ok86);
  tcase_add_test(tc, test_is_less_or_equal_ok87);
  tcase_add_test(tc, test_is_less_or_equal_ok88);
  tcase_add_test(tc, test_is_less_or_equal_ok89);
  tcase_add_test(tc, test_is_less_or_equal_ok90);
  tcase_add_test(tc, test_is_less_or_equal_ok91);
  tcase_add_test(tc, test_is_less_or_equal_ok92);
  tcase_add_test(tc, test_is_less_or_equal_ok93);
  tcase_add_test(tc, test_is_less_or_equal_ok94);
  tcase_add_test(tc, test_is_less_or_equal_ok95);
  tcase_add_test(tc, test_is_less_or_equal_ok96);
  tcase_add_test(tc, test_is_less_or_equal_ok97);
  tcase_add_test(tc, test_is_less_or_equal_ok98);
  tcase_add_test(tc, test_is_less_or_equal_ok99);
  tcase_add_test(tc, test_is_less_or_equal_ok100);
